...
// 获取登录负载
function getLoginPayload(account, password, verifyCode) {
  parameter = {
...
function decryptReturnData(encryptedData) {
    ...
    formatData.unshift()
    formatData.pop()
    var decrypt = CryptoJS.AES.decrypt(formatData.join(''), CryptoJS.enc.Utf8.parse('123456ABCDEABCDE'), {
        mode: CryptoJS.mode.ECB,
        padding: CryptoJS.pad.Pkcs7
...
// console.log(decryptReturnData("qu2f9L7agEQqZNJ1tvTT9pmLC2Ka5jhkdHY3qz0Rgpruex2kiUy37OPKcXf5Hgq/kgX1KnfnmLRV+lawzwSvTayc9Xv9ZCBHpoDfU9sTNgU="))
// console.log(decryptReturnData("qu2f9L7agEQqZNJ1tvTT9pmLC2Ka5jhkdHY3qz0Rgpruex2kiUy37OPKcXf5Hgq/DORogUmOEzZXO1haFzplVAh1Z9lCjNl474cgy217qB0="))