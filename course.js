...
// 加密请求体数据
function encryptResultData(parameter) {
  let param = {};
...
// 解密返回的数据
function decryptResultData(encryptedData) {
  formatData = encryptedData.split('"');
  formatData.unshift();
  formatData.pop();
  ...
  return JSON.parse(JSON.stringify(decrypt));
}

// 选课
function selectCourse(adz280, aac001) {
  parameter = {
    adz280,
    aac001,
  };
  param = encryptResultData(parameter);
  return param;
}

// 获取课程数据列表
function getCourseList(aac001, pageNum) {
  parameter = {
    pageNum,
    size: "5",
    adz121: "",
...
// 获取某课程下的章节视频数据
function getChapterList(adz280, aac001) {
  parameter = {
    adz280,
    aac001,
  };
...
// 获取视频数据列表
function getVideoData(adz127, adz290, aac001) {
  parameter = {
    adz127,
    adz290,
    aac001,
...
// 获取mp4视频地址
function getVideoDetailData(adz166, adz168) {
  parameter = {
    fileId: !!adz166 ? null : adz166,
    adz168,
  };
...
// 秒刷课程
function finishWatchCourse(adz290, aac001, adz341) {
  parameter = {
    adz290,
    aac001,
    adz341,
...
// 课程完结后告诉服务器刷完了
function saveVideoPlayRecord(adz290, aac001, adz341) {
  parameter = {
    adz290,
    aac001,
    adz341,
...
// 查询卷面头部信息
function queryTestPaper(aac001, adz012, adz280) {
  parameter = {
    aac001,
    adz012,
    adz280,
...
// 查询答题卡
function queryTestQuestionCards(aac001, adz012, adz280, adz420) {
  parameter = {
    aac001,
    adz012,
    adz280,
...
// 查询试题
function queryTestQuestions(aac001, adz012, adz280, adz420, adz010) {
  parameter = {
    aac001,
    adz012,
    adz280,
